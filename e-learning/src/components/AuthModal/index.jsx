...
export default function AuthModal() {
  const { showModal, handleShowModal, hanldleCloseModal } = useAuthContext();
  console.log('showModal', showModal)
  return (
    <div className={`modal modallogin ${showModal ? "open" : ""}`}>
      <div className="modal__wrapper">
        <div className="modal__wrapper-close" onClick={hanldleCloseModal}>
      ...
      <div className="modal__overlay" onClick={hanldleCloseModal}/>
    </div>
  );
}
